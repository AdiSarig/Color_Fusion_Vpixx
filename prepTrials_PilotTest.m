function [trials] = prepTrials_PilotTest(nTrialsPerLevel,params)
%
...
nContrastLevels = size(params.color.palette.reds,1); % =16? =12

nStimCat = 2; % number of stimulus categories (FHBB)
...
disp(sprintf('\n%d contrast levels\n2 stimulus categories (left, right)\n%d trials / contrast\n%d total trials\n',...
...
alpha = ([1:nContrastLevels]'*ones(1,8))'; % Color contrast level
